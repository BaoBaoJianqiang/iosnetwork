...
@interface APageViewController () {
    ...
    UIButton* saveToLocalButton;
    UIButton* readFromLocalButton;
}
...
- (void)initViews {
    ...
    saveToLocalButton = (UIButton*)[self.view viewWithTag: 108];
    [saveToLocalButton addTarget: self action: @selector(saveToLocal) forControlEvents:UIControlEventTouchUpInside];
    
    readFromLocalButton = (UIButton*)[self.view viewWithTag: 109];
    [readFromLocalButton addTarget: self action: @selector(readFromLocal) forControlEvents:UIControlEventTouchUpInside];
...
- (void) readFromLocal {
    [[CacheManager getInstance] readDataFromFile];
}
