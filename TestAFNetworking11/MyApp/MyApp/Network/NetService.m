...
+(void)invoke: (NSString*)key params:(NSMutableDictionary*)params target:(BaseViewController*)viewController {
    [[self getInstance] invoke: key params:params target: viewController success:nil fail: nil force: NO];
}

+(void)invoke: (NSString*)key target:(BaseViewController*)viewController success:(SEL)successCallback fail:(SEL)failCallback {
    [[self getInstance] invoke: key params:nil target: viewController success:successCallback fail: failCallback force: NO];
}
...
+(void)invoke: (NSString*)key params:(NSMutableDictionary*)params target:(BaseViewController*)viewController success:(SEL)successCallback fail:(SEL)failCallback {
    [[self getInstance] invoke: key params:params target: viewController success:successCallback fail: failCallback force: NO];
}
...
+(void)invoke: (NSString*)key params:(NSMutableDictionary*)params target:(BaseViewController*)viewController success:(SEL)successCallback fail:(SEL)failCallback force:(BOOL)forceFlag {
    [[self getInstance] invoke: key params:params target: viewController success:successCallback fail: failCallback force:forceFlag];
}

-(void)invoke: (NSString*)key params:(NSDictionary*)params target:(BaseViewController*)viewController success:(SEL)successCallback fail:(SEL)failCallback force:(BOOL)forceFlag {
